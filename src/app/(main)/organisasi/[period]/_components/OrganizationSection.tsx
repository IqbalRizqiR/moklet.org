      ...
      <div className="flex flex-col lg:flex-row gap-[62px] justify-between">
        ...
        <div className="w-full lg:w-[618px] flex flex-col gap-[18px]">
          {data.sectionOrgans.map((organisasi) => (
            <Link
              className="w-full rounded-xl border p-[22px] border-neutral-300 bg-white flex items-center justify-between gap-0 md:gap-[42px] group transition-all duration-300 hover:bg-glass-white hover:backdrop-blur-md hover:border-primary-200 hover:shadow-glass"
              ...
              <div className="w-full flex items-center gap-8">
                ...
                <div className="flex flex-col gap-[6px] w-[80%]">
                  ...
                  <P className="line-clamp-1">
                    {stripMarkdown(organisasi.description)}
                  </P>
                </div>
              </div>
