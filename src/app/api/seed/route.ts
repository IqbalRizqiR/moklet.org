...
export async function GET() {
  try {
    const logs: string[] = [];
    logs.push("🌱 Seeding organisation data …");
    ...
    logs.push(`✔ Period ${period.period}`);
    logs.push(`✔ Period ${period2025.period}`);
    ...
    const orgs = [
      ...
      },
      {
        ...
        logo: PLACEHOLDER_IMG,
        description:
          "Perpustakaan SMK Telkom Malang, yang dikenal dengan nama PUSTEL, merupakan bagian integral dari lingkungan sekolah yang berfokus pada pengembangan literasi dan layanan informasi bagi siswa dan staf. PUSTEL dikelola oleh tim pustakawan profesional dan didukung oleh Anggota PUSTEL dalam pengolahan buku di Perpustakaan SMK Telkom Malang.",
        vision: null,
        mission: null,
        image: PLACEHOLDER_IMG,
      ...
      },
      {
        ...
        logo: PLACEHOLDER_IMG,
        description:
          "Paskatema (Paskibra SMK Telkom Malang) adalah sub-organisasi yang berkomitmen membentuk generasi muda yang disiplin, bertanggung jawab, dan memiliki jiwa kepemimpinan tinggi.",
        vision: null,
        mission: null,
        image: PLACEHOLDER_IMG,
      ...
      },
      {
        ...
        logo: PLACEHOLDER_IMG,
        description:
          "COMET (Community of Moklet English Talent) is a sub-organization under the auspices of OSIS SMK Telkom Malang that focuses on English language activities including reading, writing, listening, and speaking.",
        vision: null,
        mission: null,
        image: PLACEHOLDER_IMG,
      ...
      },
      {
        ...
        logo: PLACEHOLDER_IMG,
        description:
          "Pecinta Alam Wana Arga (PALWAGA) adalah sub-organisasi di bawah naungan OSIS SMK Telkom Malang yang berfokus pada kegiatan kepecintaalaman dan keterampilan bertahan hidup.",
        vision: null,
        mission: null,
        image: PLACEHOLDER_IMG,
      ...
      },
      {
        ...
        logo: PLACEHOLDER_IMG,
        description:
          "Badan Dakwah Islam (BDI) merupakan Sub-Organisasi keagamaan yang bergerak di bidang dakwah, pendidikan, dan pembinaan umat Islam di SMK Telkom Malang.",
        vision:
        ...
        mission:
          "1. Menanamkan nilai-nilai keislaman dalam kehidupan pelajar melalui kegiatan dakwah yang kreatif, edukatif, dan menyenangkan.\n2. Membentuk karakter siswa yang religius, berakhlak mulia, serta mampu menjadi teladan.\n3. Menjalin kolaborasi dengan organisasi siswa lainnya untuk memperkuat nilai-nilai Islami.",
        image: PLACEHOLDER_IMG,
      ...
      },
      {
        ...
        logo: PLACEHOLDER_IMG,
        description:
          "Moklet Art Club (MAC) sebagai wadah bagi siswa-siswi untuk mengasah kreativitas dan mengembangkan bakat di bidang kesenian. MAC membina tiga divisi utama: Akustik, Tari Tradisional Modern, dan Teater.",
        vision:
          "Mengembangkan SubOrganisasi Moklet Art Club untuk menjadi salah satu sumber inspirasi dan ekspresi kreatif.",
        mission:
          "1. Memberi wadah untuk mengembangkan potensi dan minat bakat siswa-siswi dalam bidang seni.\n2. Meningkatkan rasa kebersamaan, kerjasama serta kolaboratif secara kreatif dan inovatif.\n3. Melanjutkan dan mengembangkan inovasi kreatif di berbagai progja MAC.",
        image: PLACEHOLDER_IMG,
    ...
    for (const org of orgs) {
      for (const p of [period, period2025]) {
        ...
        logs.push(`✔ ${org.organisasi} — ${p.period}`);
      }
    }
